...
namespace ExitGames.Client.Photon.Chat
{
    ...
    public class ChatClient : IPhotonPeerListener
    {
            ...
            switch (statusCode)
            {
                ...
                case StatusCode.Disconnect:
                    ...
                    else
                    {
                        ...
                        // add by common, if user did'nt quit app, manually reconnected;
                        if (!Global.isQuit) {
        ...
        private void ConnectToFrontEnd()
        {
            ...
            Console.WriteLine("---connectTOFrondEnd, frontend Address: " + this.FrontendAddress + ", chat app name:" + ChatAppName);           
        }
